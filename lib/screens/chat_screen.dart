...
import 'package:flutter_application/services/assets_manager.dart';
...
class _ChatScreenState extends State<ChatScreen> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: Padding(
            ...
            child: Image.asset(AssetsManager.gptImage)),
  ...
  Future<void> sendMessageFCT({required ModelsProvider modelsProvider, required ChatProvider chatProvider}) async {
    ...
    if(_isTyping){
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: TextWidget(
          label: "You can't send multiple requests at a time",
        ),
        backgroundColor: Colors.red,
      ));
      return;
    ...
    try {
      ...
      log("request button has been pressed");
      setState(() {
        _isTyping = true;
